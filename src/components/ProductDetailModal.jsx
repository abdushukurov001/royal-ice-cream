        ...
        >
            <div className="bg-white rounded-lg shadow-lg overflow-hidden w-full max-w-5xl max-h-[calc(100vh-3rem)]">
                <div className="flex justify-between items-center p-4 border-b-white">
                    <h2 className="text-xl font-bold capitalize text-[#FF1493]">{product.title}</h2>
                ...
                <div className="p-6 flex flex-col max-h-[calc(100vh-10rem)] overflow-y-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-6 mt-6 max-h-[calc(100vh-10rem)] flex flex-col justify-between overflow-y-auto">
                            <div>
                                <h3 className="text-2xl font-semibold">Mahsulot haqida batafsil:</h3>
                                <p className="ms-4 text-gray-600 text-lg">{product.description}</p>
                            </div>

                            <div className="max-h-[300px] flex flex-col justify-between overflow-y-auto">
